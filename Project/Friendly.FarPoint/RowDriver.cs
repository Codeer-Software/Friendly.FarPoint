...
#if ENG
    /// <summary>
    /// Provides operations on controls of type FarPoint.Win.Spread.Row.
    /// </summary>
#else
    /// <summary>
    /// TypeがFarPoint.Win.Spread.Rowに対応した操作を提供します。
    /// </summary>
#endif
    public class RowDriver: IAppVarOwner
    {
#if ENG
        /// <summary>
        ...
        internal RowDriver(AppVar appVar)
        {
            AppVar = appVar;
        }
    }
